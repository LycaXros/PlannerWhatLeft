...
namespace TestViewApp.ViewModels {
    ...
    /// <summary>
    /// Represents the Tarea collection view model.
    /// </summary>
    public partial class TareaCollectionViewModel : CollectionViewModel<Tarea, int, IPlanningOtherUnitOfWork> {

        /// <summary>
        /// Creates a new instance of TareaCollectionViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static TareaCollectionViewModel Create(IUnitOfWorkFactory<IPlanningOtherUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected TareaCollectionViewModel(IUnitOfWorkFactory<IPlanningOtherUnitOfWork> unitOfWorkFactory = null)
            : base(unitOfWorkFactory ?? UnitOfWorkSource.GetUnitOfWorkFactory(), x => x.Tarea) {
        }
    }
}